...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/28 11:17:20 by lignigno          #+#    #+#             */
/*   Updated: 2021/01/23 08:37:03 by lignigno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			printninvis_bonus(char *str, int n);
void			dummy_bonus(void);
char			compare_char_with(const char *arr_char, char type);
